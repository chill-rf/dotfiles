...
M.tmux_keybinds = {
	...
	{ key = "j", mods = "SUPER|CTRL", action = act({ PasteFrom = "PrimarySelection" }) },
	...
	{ key = "h", mods = "SUPER|SHIFT|CTRL", action = act({ AdjustPaneSize = { "Left", 1 } }) },
	{ key = "l", mods = "SUPER|SHIFT|CTRL", action = act({ AdjustPaneSize = { "Right", 1 } }) },
	{ key = "k", mods = "SUPER|SHIFT|CTRL", action = act({ AdjustPaneSize = { "Up", 1 } }) },
	{ key = "j", mods = "SUPER|SHIFT|CTRL", action = act({ AdjustPaneSize = { "Down", 1 } }) },
...
M.default_keybinds = {
	...
	{ key = "z", mods = "SUPER", action = "ReloadConfiguration" },
	{ key = "z", mods = "SUPER|SHIFT", action = act({ EmitEvent = "toggle-tmux-keybinds" }) },
	...
	{ key = "f", mods = "SUPER", action = act.RotatePanes("Clockwise") },
}
