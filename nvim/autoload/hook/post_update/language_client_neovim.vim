function! hook#post_update#language_client_neovim#load() abort
  ...
  let l:jdt_lsp_version = '0.42.0-201907181837'
  ...
  if !executable(l:jdt_lsp_path . "/plugins/" . expand(g:ldt_lsp_jar_name) . ".jar")
    ...
    execute "!curl -L -o /tmp/tmp_jdt_lsp.tar.gz http://download.eclipse.org/jdtls/snapshots/jdt-language-server-" . l:jdt_lsp_version . ".tar.gz"
